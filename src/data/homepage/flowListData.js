export const flowListDataEN = [
    ...
    {
        text: "Royalties generated from track streams are distributed to token holders automatically"
    },
    {
...
export const flowListDataUK = [
    ...
    {
        text: "Роялті генеруються зі стрімінгу треків і розподіляються між токенхолдерами автоматично"
    },
    {
