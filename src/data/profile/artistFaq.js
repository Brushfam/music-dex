...
export const artistFaqEN = [
  [
    {
      question: "How is the payment of savings from songs carried out?",
      answer:
  ...
  [
    ...
    },
    {
      ...
      answer:
        "By tokenizing a part of the track, you allow your fans to support you and help develop your creative path. You can raise funds for your musical activity while earning with your fans.",
    },
  ],
];

export const artistFaqUA = [
  [
    {
  ...
  [
    ...
    },
    {
      ...
      answer:
        "Токенізуючи частину треку, ви дозволяєте своїм шанувальникам підтримувати вас і допомагати розвивати ваш творчий шлях. Ви можете збирати кошти на свою музичну діяльність, заробляючи разом зі своїми шанувальниками.",
    },
  ],
];
